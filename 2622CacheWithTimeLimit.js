...
// At t=0, a key-value pair (1: 42) is added with a time limit of 100ms. The value
...
TimeLimitedCache.prototype.set = function (key, value, duration) {
  let tid = setTimeout(() => this.cache.delete(key), duration);
  let ret = false;
...
/**
 * @param {number} key
 * @return {number} value associated
 */
