...
// removed and replaced with the actual elements in that sub-array. This flattening
// operation should only be done if the current depth of nesting is less than n.
